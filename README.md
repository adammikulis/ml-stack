...
| `ml-stack <command>` | runs any `ml-stack-<command>` below (`ml-stack do ...`, `ml-stack bench sweep ...`, `ml-stack train run ...`); `--list` prints each with the first line of its help; bare, the daemon and your browser on it. Also `ml-stack-traind`, `ml-stack-peers`, `ml-stack-train-run` |
