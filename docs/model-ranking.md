...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `Qwen3.8-Flash-Next-UD-Q4_K_XL-00001-of-00004.gguf` | 80% | 89% | 77% | 100 | 26.7 | 7s | 99.0G | - | greedy | words | 159 | its own run on unsloth/llama-server |
...
Runs whose F1 fell more than 5 points under their model's, so their cost was not taken -- a head cannot change an answer, so look at what else these changed:
