...
rather than merely constructing it:
    ...
    from mainspring.speech import ASR, TTS, FasterWhisperASR, SystemTTS
...
from mainspring.speech.asr import (
...
from mainspring.speech.registry import Registry
from mainspring.speech.tts import KokoroOnnxTTS, PiperTTS, SystemTTS
from mainspring.speech.vad import EnergyVAD, SileroVAD, pcm_to_floats, rms
