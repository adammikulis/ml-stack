...
The same function then runs on both frameworks, and ``mainspring.testing`` proves the two
agree numerically -- forward and backward.
"""

from __future__ import annotations

from mainspring.backend.determinism import SeedReport, set_seeds
from mainspring.backend.device import (
    DeviceProfile,
    Vendor,
    detect_device,
    resolve_torch_device,
)
from mainspring.backend.ops import ArrayBackend, ArrayOps, bind_device
from mainspring.backend.registry import (
    BACKENDS,
    BackendUnavailable,
    available,
    detect_backend,
